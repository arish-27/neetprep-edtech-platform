...
export function AdminLoginScreen() {
    ...
    return (<AuthFrame title="Teacher sign in" subtitle="Upload content and review student progress.">
      <form className="space-y-4" onSubmit={async (e) => {
        ...
        <div className="space-y-2">
          ...
          <Input value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@example.com" type="email" autoComplete="email" required/>
        </div>
        <div className="space-y-2">
        ...
        <Button type="button" variant="secondary" className="w-full h-11 rounded-2xl" disabled={loading} onClick={async () => {
            setEmail(demoEmail);
