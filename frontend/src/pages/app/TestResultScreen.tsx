...
export function TestResultScreen() {
  ...
  const attempt = useMemo(() => {
    ...
    if (!selectedAttemptId) return attempts[0] ?? null;
    ...
    <div className="space-y-4">
          ...
          {attempts.slice(0, 8).map((a, i) => {
            ...
            return (
              <button
                ...
                title={new Date(a.finishedAt).toLocaleString()}
              >
      ...
      <div className="grid gap-4">
        {attempt.questionOrder.map((questionId, i) => {
          ...
          return (
            <Card key={questionId} className="p-5">
              ...
              <div className="mt-3 grid gap-2 md:grid-cols-2">
                {q.options.map((opt, idx) => {
                  ...
                  return (
                    <div key={opt} className={cn("rounded-2xl border px-4 py-3 shadow-soft", pill)}>
