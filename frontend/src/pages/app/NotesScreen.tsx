...
import { type NoteItem, starterNotes } from "@/data/mockData";
              ...
              <motion.div key={n.id} variants={staggerItem}>
                <Card interactive className="p-4">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <button type="button"
                      className="grid h-9 w-9 place-items-center rounded-2xl border border-white/10 bg-white/10 text-ink-600 dark:text-ink-200 transition hover:bg-red-500/20 hover:text-red-500 focus-ring"
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="w-full min-h-[200px] rounded-3xl border border-white/10 bg-white/10 px-4 py-3 text-sm font-semibold text-ink-900 dark:text-ink-100 focus-ring placeholder:text-ink-400"
