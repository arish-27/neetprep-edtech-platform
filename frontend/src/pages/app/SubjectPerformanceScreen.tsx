...
import { Activity, BookOpen, CheckCircle2, Clock, Loader2, TrendingUp } from "lucide-react";
...
import { api, type ApiStudentPerformance } from "@/lib/api";
...
export function SubjectPerformanceScreen() {
  ...
  const [performances, setPerformances] = useState<ApiStudentPerformance[]>([]);
