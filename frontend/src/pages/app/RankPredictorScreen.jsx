...
export function RankPredictorScreen() {
    ...
    return (<div className="space-y-5">
      ...
      {prediction && (<>
          ...
          {prediction.improvement_tips.length > 0 && (<Reveal delay={0.1}>
              <Card className="p-5">
                ...
                <motion.div className="space-y-2" variants={staggerContainer} initial="hidden" animate="show">
                  {prediction.improvement_tips.map((tip, i) => (<motion.div key={i} variants={staggerItem} className="flex items-start gap-3 rounded-2xl border border-amber-500/20 bg-amber-500/10 p-3">
      ...
      {plan && (<Reveal delay={0.15}>
          <Card className="p-5">
            ...
            <div className="space-y-2">
              {plan.weekly_plan.map((week) => (<div key={week.week} className="rounded-2xl border border-white/10 bg-white/5 p-3">
